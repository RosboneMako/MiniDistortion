...
public:
    ...
    void drawRotarySlider(juce::Graphics& g, int x, int y, int width, int height, float sliderPos, const float rotaryStartAngle, const float rotaryEndAngle, juce::Slider& sld) override
    {
        ...
        case 12: //R5.02 Dark Amp Knob (C)
            ...
            break;
        case 13: //R5.06 Dark Amp Knob Small (D) BLUE
            DrawKnob = false;
            DrawKnobEdge = false;
            DrawKnobEdge2 = false;
            DrawGuitarStyle = false;
            ...
            Tick = juce::Colour(0xFFF0F0F0);
            break;
        case 14: //R5.06 Dark Amp Knob Small (E) GREEN
            DrawKnob = false;
            DrawKnobEdge = false;
            DrawKnobEdge2 = false;
            DrawGuitarStyle = false;
            ...
            Tick = juce::Colour(0xFFF0F0F0);
            break;
        case 15: //R5.06 Dark Amp Knob Small (F) AMBER
            DrawKnob = false;
            DrawKnobEdge = false;
            DrawKnobEdge2 = false;
            DrawGuitarStyle = false;
            ...
            Tick = juce::Colour(0xFFF0F0F0);
            break;
        case 16: //R5.06 Dark Amp Knob Small (10) RED
            DrawKnob = false;
            DrawKnobEdge = false;
            DrawKnobEdge2 = false;
            DrawGuitarStyle = false;
...
private:
    ...
    //R5.05 Define our UI Juce Slider controls.
    juce::Slider sldKnob[125];
    
    //R4.00 Future use for different languages.
    //int sldKnob_Help[125];      //R4.00 index into the Help String array. Indexes changed for pedals and Mods.
    ...
    enum enKnobIndexes {
        ...
        e_GateOn, e_GateVol, e_GateExp, e_GateAvg, e_GateFreq, e_GateWah, e_GateWahQ, e_GateWahRange,
        e_CompOn, e_CompVol, e_CompAtt, e_CompRel, e_CompThr, e_CompRat, e_CompDrv, e_CompFreq, e_CompMix,
        e_Dist1On, e_Dist1Vol, e_Dist1MidF, e_Dist1Mid, e_Dist1MidQ, e_Dist1Cut, e_Dist1Drv,
        e_Mod1On, e_Mod1Vol, e_Mod1Rate, e_Mod1Depth, e_Mod1Reg, e_Mod1Mix, e_Mod1Tone, e_Mod1Synth, e_Mod1Bronz,
        e_Mod2On, e_Mod2Vol, e_Mod2Rate, e_Mod2Range, e_Mod2FStart, e_Mod2Mix, 
    ...
    t_KnobCoors Knob_Pos[125] = {};
    juce::String Knob_Name[125] = {};
    ...
    //int DefAmp_Page = 0;      //R5.05 Moved to processor.
    ...
    //int DefIR_Page = 0;                 //R5.05 Moved to processor.
    int IR_LastSelected = 0;              //R5.01 Added.
    bool IR_NeedsRedraw = false;
    ...
    //int DefAmp_CurrentIdx = 0;                          //R5.05 Moved to processor.
    //int DefAmp_Editing = 0;                             //R5.05 Moved to processor. Edit mode. 0-Not editing, 1-Editing, 2-Data needs saved.
    void MAKO_Amp_UpdateDef();
    void FILE_Mako_Amp_Load_Def(juce::String tFile);

    //int DefIR_CurrentIdx = 0;                           //R5.05 Moved to processor.
    ...
    {   
        ...
        "FREQ: Focus compression trigger on this frequency. 4k = off.",
        "MIX: Adjust the balance of clean to comp signals. (.7 to .8 is a good start).",
...
public:
    ...
    std::unique_ptr <juce::AudioProcessorValueTreeState::SliderAttachment> ParAtt[125]; 
