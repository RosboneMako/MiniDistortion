...
public:
    ...
    void drawRotarySlider(juce::Graphics& g, int x, int y, int width, int height, float sliderPos, const float rotaryStartAngle, const float rotaryEndAngle, juce::Slider& sld) override
    {
        ...
        case 2: //R5.02 Red.
            ...
            break;
        case 3: //R5.02 Blue
            ColGrad = juce::ColourGradient(juce::Colour(0xFF6969A2), 0.0f, y, juce::Colour(0xFF3F3F78), 0.0f, y + height, false);
            DrawKnobEdge = true;
            DrawKnobNotches = false;
            break;        
        case 4: //R5.02 Green
            ColGrad = juce::ColourGradient(juce::Colour(0xFF636D50), 0.0f, y, juce::Colour(0xFF525D40), 0.0f, y + height, false);
            DrawKnobEdge = true;
            DrawKnobNotches = false;
            break;        
        case 5: //R5.02 Orange
