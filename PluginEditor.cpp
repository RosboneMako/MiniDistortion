    ...
    : AudioProcessorEditor (&p), makoProcessor (p)
{
    ...
    GUI_Init_Large_Slider(&sldKnob[e_AmpCompF], *makoProcessor.Setting[e_AmpCompF], 50, 3000, 50, "");
    ...
    GUI_Init_Large_Slider(&sldKnob[e_AmpAirF], *makoProcessor.Setting[e_AmpAirF], 500, 2500, 50, "");
    ...
    GUI_Init_Large_Slider(&sldKnob[e_Mod1Reg], *makoProcessor.Setting[e_Mod1Reg], .0f, 1.0f, .01f, "");
    ...
    GUI_Init_Large_Slider(&sldKnob[e_Mod4Foff], *makoProcessor.Setting[e_Mod4Foff], -1.0f, 1.0f, .01f, "");
    GUI_Init_Large_Slider(&sldKnob[e_Mod4Doff], *makoProcessor.Setting[e_Mod4Doff], -1.0f, 1.0f, .01f, "");
    ...
    GUI_Init_Large_Slider(&sldKnob[e_DelTime], *makoProcessor.Setting[e_DelTime], .0f, 1.0f, .01f, "");
    GUI_Init_Large_Slider(&sldKnob[e_DelMix], *makoProcessor.Setting[e_DelMix], .0f, 1.0f, .01f, "");
    GUI_Init_Large_Slider(&sldKnob[e_DelOffset], *makoProcessor.Setting[e_DelOffset], .0f, 1.0f, .01f, "");
    GUI_Init_Large_Slider(&sldKnob[e_DelRepeat], *makoProcessor.Setting[e_DelRepeat], .0f, 1.0f, .01f, "");
    GUI_Init_Large_Slider(&sldKnob[e_DelBal], *makoProcessor.Setting[e_DelBal], .0f, 1.0f, .01f, "");
    GUI_Init_Large_Slider(&sldKnob[e_DelDuck], *makoProcessor.Setting[e_DelDuck], .0f, 1.0f, .01f, "");
    ...
    GUI_Init_Large_Slider(&sldKnob[e_CompFreq], 4000, 50, 4000, 50, "");  //R5.05 Added.
    GUI_Init_Large_Slider(&sldKnob[e_CompMix], .0f, .0f, 1.0f, .01f, ""); //R5.06 Added.
    ...
    GUI_Init_Large_Slider(&sldKnob[e_Dist2High], .0f, -1.0f, 1.0f, .01f, "");
    ...
    KNOB_DefinePosition(e_AmpThump, 112, 100, 50, 50, "Thump", true);
    KNOB_DefinePosition(e_AmpAir, 162, 100, 50, 50, "Air", true);
    KNOB_DefinePosition(e_AmpAirF, 212, 100, 50, 50, "Air F", true);
    KNOB_DefinePosition(e_AmpPower, 262, 100, 50, 50, "Power", true);
    ...
    sldKnob[e_AmpCompF].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000010));
    sldKnob[e_AmpQual].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000010));
    sldKnob[e_AmpSlope].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000010));
    sldKnob[e_AmpThump].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000F));
    sldKnob[e_AmpAir].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000F));
    sldKnob[e_AmpAirF].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000F));
    sldKnob[e_AmpPower].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000F));
    sldKnob[e_AmpComp].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000010));
    sldKnob[e_AmpCRatio].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000010));
    sldKnob[e_AmpVol].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000F));
    sldKnob[e_AmpGain].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000F));
    ...
    //4.00 Using the Outline color to define the KNOB style.
    sldKnob[e_AmpBoom].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000E));
    sldKnob[e_AmpCrisp].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000E));
    //sldKnob[e_AmpThump].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000F));
    //sldKnob[e_AmpAir].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000F));
    //sldKnob[e_AmpAirF].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000F));
    //sldKnob[e_AmpPower].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000F));
    sldKnob[e_AmpHP].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000D));
    sldKnob[e_AmpEQMode].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000D));
    sldKnob[e_AmpEQ1].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000D));
    sldKnob[e_AmpEQ2].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000D));
    sldKnob[e_AmpEQ3].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000D));
    sldKnob[e_AmpEQ4].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000D));
    sldKnob[e_AmpEQ5].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000D));
    sldKnob[e_AmpEQ6].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000D));
    sldKnob[e_AmpLP].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000D));

    KNOB_DefinePosition(e_IRSize, 0, 140, 180, 20, "Size", true);
    KNOB_DefinePosition(e_IRVol, 0, 180, 180, 20, "Vol", true);
        
    sldKnob[e_CompVol].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000006));
    sldKnob[e_CompAtt].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000006));
    sldKnob[e_CompRel].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000006));
    sldKnob[e_CompThr].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000006));
    sldKnob[e_CompRat].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000006));
    sldKnob[e_CompDrv].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000006));
    sldKnob[e_CompFreq].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000006)); //R5.05 Added.
    sldKnob[e_CompMix].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000006));  //R5.06 Added.

    sldKnob[e_Dist1Vol].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000A));
    sldKnob[e_Dist1MidF].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000A));
    sldKnob[e_Dist1Mid].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000A));
    sldKnob[e_Dist1MidQ].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000A));
    sldKnob[e_Dist1Cut].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000A));
    sldKnob[e_Dist1Drv].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000A));

    sldKnob[e_Dist2Vol].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000007));
    sldKnob[e_Dist2MidF].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000007));
    sldKnob[e_Dist2Mid].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000007));
    sldKnob[e_Dist2MidQ].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000007));
    sldKnob[e_Dist2High].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000007));
    sldKnob[e_Dist2Cut].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000007));
    sldKnob[e_Dist2Drv].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000007));

    sldKnob[e_Mod1Rate].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000B)); 
    sldKnob[e_Mod1Depth].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000B));
    sldKnob[e_Mod1Reg].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000B));
    sldKnob[e_Mod1Mix].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000B));
    sldKnob[e_Mod1Synth].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000B));
    sldKnob[e_Mod1Bronz].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000B));
    sldKnob[e_Mod1Vol].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000B));

    sldKnob[e_Mod2Rate].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000008));
    sldKnob[e_Mod2Range].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000008));
    sldKnob[e_Mod2FStart].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000008));
    sldKnob[e_Mod2Mix].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000008));
    sldKnob[e_Mod2Vol].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000008));

    sldKnob[e_Mod3Rate].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000C));
    sldKnob[e_Mod3Depth].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000C));
    sldKnob[e_Mod3Mix].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000C));
    sldKnob[e_Mod3Tone].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000C));
    sldKnob[e_Mod3Bal].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000C));
    sldKnob[e_Mod3Vol].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000C));

    sldKnob[e_Mod4Foff].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000009)); //1
    sldKnob[e_Mod4Doff].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000009));
    sldKnob[e_Mod4Mix].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000009));
    sldKnob[e_Mod4Tone].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000009));    
    sldKnob[e_Mod4Vol].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000009));
    sldKnob[e_Mod4Bal].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000009));

    sldKnob[e_EQVol].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000000));    
    sldKnob[e_EQF1F].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000F));
    sldKnob[e_EQF1Q].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000F));
    sldKnob[e_EQF1A].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000005));    
    sldKnob[e_EQF2F].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000D));
    sldKnob[e_EQF2Q].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000D));
    sldKnob[e_EQF2A].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000003));    
    sldKnob[e_EQF3F].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000E));
    sldKnob[e_EQF3Q].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x0000000E));
    sldKnob[e_EQF3A].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000004));    
    sldKnob[e_EQF4F].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000010));
    sldKnob[e_EQF4Q].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000010));
    sldKnob[e_EQF4A].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000002));

    sldKnob[e_DelMix].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000001));
    sldKnob[e_DelTime].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000001));
    ...
    labVersion.setText("v5.06s", juce::dontSendNotification);
    ...
    ParAtt[e_AmpAirF] = std::make_unique <juce::AudioProcessorValueTreeState::SliderAttachment>(p.parameters, "amp_airf", sldKnob[e_AmpAirF]);
    ...
    ParAtt[e_Mod1Reg] = std::make_unique <juce::AudioProcessorValueTreeState::SliderAttachment>(p.parameters, "mod1_regen", sldKnob[e_Mod1Reg]);
    ...
    ParAtt[e_CompFreq] = std::make_unique <juce::AudioProcessorValueTreeState::SliderAttachment>(p.parameters, "comp_freq", sldKnob[e_CompFreq]); //R5.05 Added.
    ParAtt[e_CompMix] = std::make_unique <juce::AudioProcessorValueTreeState::SliderAttachment>(p.parameters, "comp_mix", sldKnob[e_CompMix]);    //R5.06 Added.         
    ...
    //************************************************************************
    //R5.05 Update button toggle state when DAW resets everything.
    if (makoProcessor.InputEQ_4xOS == true)
        butAmp4x.setToggleState(true, juce::dontSendNotification);
    else
        butAmp4x.setToggleState(false, juce::dontSendNotification);
    
    //R5.05 Upate button toggle state when DAW resets everything.
    if (makoProcessor.makoVUHide == 1)
        butVUHide.setToggleState(true, juce::dontSendNotification);
    else
        butVUHide.setToggleState(false, juce::dontSendNotification);

    //R5.05 Set the edit mode to the stored processor value. DAW resets everything when focus is lost/gained.
    //R5.05 Dont return to database editing mode.
    editMode = makoProcessor.makoEditMode;
    //if (editMode == EM_DefAmps) editMode = 0;
    //if (editMode == EM_DefIRs) editMode = 0;
...
{     
    ...
    if (editMode != editModeLast)
    {
        ...
        //R5.05 Store the edit mode in the processor so we can come back to it on DAW reset.
        makoProcessor.makoEditMode = editMode;
    }
    ...
    { 
        ...
        if (makoProcessor.DefAmp_Editing == 2)
        {
            makoProcessor.DefAmp_Editing = 0;                //R3.00 reset our Database editing var.
...
{   
    ...
    //R5.01 White - Noise Gate.
    Paint_Back3(g, juce::Colour(0xFFF0F0F0), juce::Colour(0xFF000000));
    Paint_VertDiv(g, 105, 100, 180);
    Paint_VertDiv(g, 325, 100, 180);

    //R5.02 Header rectangles.
    g.setColour(juce::Colour(0xFF000000));
    g.fillRoundedRectangle(32.0f, 95.0f, 66.0f, 15.0f, 4.0f);
    g.setColour(juce::Colour(0xFFAC5500));
    g.fillRoundedRectangle(112.0f, 95.0f, 206.0f, 15.0f, 4.0f);
    //g.fillRoundedRectangle(182.0f, 96.0f, 66.0f, 15.0f, 4.0f);
    //g.fillRoundedRectangle(252.0f, 96.0f, 66.0f, 15.0f, 4.0f);
    g.setColour(juce::Colour(0xFF5E4A80));
    g.fillRoundedRectangle(332.0f, 95.0f, 206.0f, 15.0f, 4.0f);
    ...
    g.setFont(26.0f);
    //g.setColour(juce::Colour(0xFF000000));
    g.setGradientFill(juce::ColourGradient(juce::Colour(0xFF505050), 395, 200, juce::Colour(0xFFA0A0A0), 560, 230, false));
    g.drawText("G A T E W A H", 395, 200, 200, 15, juce::Justification::centredLeft, 0);
...
void MakoDist01AudioProcessorEditor::Paint_Ped2(juce::Graphics& g)
{
    ...
    sldKnob[e_CompFreq].setVisible(true); //R5.05 Added.
    sldKnob[e_CompMix].setVisible(true);  //R5.06 Added.
    labPedal2_Comp.setVisible(true);

    //R5.02 Red - Compressor.
    Paint_Back3(g, juce::Colour(0xFFC03030), juce::Colour(0xFF000000)); 
    //Paint_VertDiv(g, 85, 100, 180);
    //Paint_VertDiv(g, 485, 100, 180);
    ...
    g.setColour(juce::Colour(0xFFFFFFFF));
    g.drawText("Volume", 10, 95, 70, 15, juce::Justification::centred, 0);
    g.drawText("Attack", 80, 95, 70, 15, juce::Justification::centred, 0);
    g.drawText("Release", 150, 95, 70, 15, juce::Justification::centred, 0);
    g.drawText("Threshold", 220, 95, 70, 15, juce::Justification::centred, 0);
    g.drawText("Ratio", 290, 95, 70, 15, juce::Justification::centred, 0);
    g.drawText("Trig Freq", 360, 95, 70, 15, juce::Justification::centred, 0);
    g.drawText("Mix", 430, 95, 70, 15, juce::Justification::centred, 0);
    g.drawText("Drive", 500, 95, 70, 15, juce::Justification::centred, 0);
...
void MakoDist01AudioProcessorEditor::Paint_Ped3(juce::Graphics& g)
{
    ...
    //R5.02 GREEN - Distortion.
    Paint_Back3(g, juce::Colour(0xFF8BBE5A), juce::Colour(0xFF000000));
    ...
    //R5.02 Header rectangles.
    g.setColour(juce::Colour(0xFF000000));
    g.fillRoundedRectangle(45.0f, 96.0f, 69.0f, 14.0f, 4.0f);
    g.fillRoundedRectangle(130.0f, 96.0f, 310.0f, 14.0f, 4.0f);
    g.fillRoundedRectangle(455.0f, 96.0f, 69.0f, 14.0f, 4.0f);
    
    //R5.02 Changed text color.
    g.setColour(juce::Colour(0xFFFFFFFF));
...
void MakoDist01AudioProcessorEditor::Paint_Ped4(juce::Graphics& g)
{
    ...
    //R5.01 ORANGE - Distortion.
    Paint_Back3(g, juce::Colour(0xFFB64F0A), juce::Colour(0xFF000000));
    g.setColour(juce::Colour(0xFFB24D0A));
    g.fillRoundedRectangle(20.0f, 90.0f, 70.0f, 100.0f, 8.0f);
    g.fillRoundedRectangle(480.0f, 90.0f, 70.0f, 100.0f, 8.0f);
...
void MakoDist01AudioProcessorEditor::Paint_Ped5(juce::Graphics& g)
{
    ...
    //R5.02 Sage.
    Paint_Back3(g, juce::Colour(0xFFA0A090), juce::Colour(0xFF303020));
...
{    
    ...
    sldKnob[e_Mod1Reg].setVisible(true);
    ...
    Paint_Back3(g, juce::Colour(0xFF505096), juce::Colour(0xFF101030));
    Paint_VertDiv(g, 390, 100, 180);
    ...
    g.setColour(juce::Colour(0xFFFFFFFF));
    g.drawText("Volume", 30, 95, 70, 15, juce::Justification::centred, 0);
    g.drawText("Rate", 100, 95, 70, 15, juce::Justification::centred, 0);
    g.drawText("Depth", 170, 95, 70, 15, juce::Justification::centred, 0);
    g.drawText("Regen", 240, 95, 70, 15, juce::Justification::centred, 0);
    g.drawText("Mix", 310, 95, 70, 15, juce::Justification::centred, 0);
    g.drawText("Synth", 400, 95, 70, 15, juce::Justification::centred, 0);
    g.drawText("Bronz", 470, 95, 70, 15, juce::Justification::centred, 0);

    //R5.01 Changed.
    g.setColour(juce::Colour(0xFFC0C0C0));
    g.drawText("Short modulated delay effect that creates a doppler/airplane swoosh.", 10, 209, 580, 15, juce::Justification::centredLeft, 0);
...
void MakoDist01AudioProcessorEditor::Paint_Mod2(juce::Graphics& g)
{
    ...
    //R5.02 Draw color Background.
    Paint_Back3(g, juce::Colour(0xFF009696), juce::Colour(0xFF000000));
    g.setColour(juce::Colour(0xFF101010));
    g.fillRoundedRectangle(85.0f, 90.0f, 400.0f, 100.0f, 8.0f);
...
void MakoDist01AudioProcessorEditor::Paint_Mod3(juce::Graphics& g)
{
    ...
    //R4.00 Draw color Background.
    Paint_Back3(g, juce::Colour(0xFF505096), juce::Colour(0xFF101020));
    g.setGradientFill(juce::ColourGradient(juce::Colour(0xFF4A5000), 0, 90, juce::Colour(0xFF8A9000), 0, 190, false));
    g.fillRoundedRectangle(205.0f, 90.0f, 320.0f,100.0f, 8.0f);
    g.setColour(juce::Colour(0xFFE0E0E0));
    g.drawRoundedRectangle(205.0f, 90.0f, 320.0f, 100.0f, 8.0f,1.0f);    
    g.fillRect(10.0f, 204.0f, 555.0f, 2.0f);
    ...
    g.drawText("Mix", 120, 95, 70, 15, juce::Justification::centred, 0);
    g.drawText("Rate", 210, 95, 70, 15, juce::Justification::centred, 0);
    g.drawText("Depth", 290, 95, 70, 15, juce::Justification::centred, 0);
...
void MakoDist01AudioProcessorEditor::Paint_Mod4(juce::Graphics& g)
{
    ...
    g.setGradientFill(juce::ColourGradient(juce::Colour(0xFFC0C0C0), 0, 63, juce::Colour(0xFF808080), 570, 250, false));
    g.fillRoundedRectangle(40.0f, 95.0f, 490.0f, 90.0f, 4.0f);
    g.setColour(juce::Colour(0xFF000000));
    g.drawRoundedRectangle(40.0f, 95.0f, 490.0f, 90.0f, 4.0f, 1.0f);
    g.setColour(juce::Colour(0xFF000000));
    g.fillEllipse(42, 97, 6, 6);
    g.fillEllipse(42, 176, 6, 6);    
    g.fillEllipse(521, 97, 6, 6);
    g.fillEllipse(521, 176, 6, 6);

    //R5.02 HEADERS
    g.setFont(12.0f);
    Text_Title(g, 10, 70, juce::Colour(0xFF000000), juce::Colour(0xFFFFFFFF), "WIDE LOAD (stereo)");
    
    //R5.02 Updated colors.
    g.setFont(12.0f);
    g.setColour(juce::Colour(0xFF000000));//FFC080
...
void MakoDist01AudioProcessorEditor::Paint_Amp(juce::Graphics& g)
{
    ...
    //R5.02 Draw color Background.
    Paint_Back3(g, juce::Colour(0xFF505050), juce::Colour(0xFF101010));
    ...
    g.drawText("Thump", 110, 88, 50, 15, juce::Justification::centred, 0);
    g.drawText("Air", 160, 88, 50, 15, juce::Justification::centred, 0);
    g.drawText("Air F", 210, 88, 50, 15, juce::Justification::centred, 0);
    g.drawText("Power", 260, 88, 50, 15, juce::Justification::centred, 0);
...
void MakoDist01AudioProcessorEditor::Paint_Delay(juce::Graphics& g)
{
    ...
    Paint_Back3(g, juce::Colour(0xFF6C7C8A), juce::Colour(0xFF2B3035));
    g.setColour(juce::Colour(0xFF202020));
    g.fillRoundedRectangle(122.0f, 90.0f, 330.0f, 15.0f, 8.0f);
    ...
    g.setColour(juce::Colour(0xFFFFFFFF));
    g.drawText("D I G I T A L   D E L A Y", 122, 90, 330, 15, juce::Justification::centred, 0);
    g.drawText("Mix", 20, 100, 85, 15, juce::Justification::centred, 0);
    g.drawText("Repeat", 118, 115, 70, 15, juce::Justification::centred, 0);
    g.drawText("Offset", 208, 115, 70, 15, juce::Justification::centred, 0);
    g.drawText("Balance", 298, 115, 70, 15, juce::Justification::centred, 0);
    g.drawText("Ducking", 388, 115, 70, 15, juce::Justification::centred, 0);
    g.drawText("Time", 470, 100, 85, 15, juce::Justification::centred, 0);
...
void MakoDist01AudioProcessorEditor::Paint_Reverb(juce::Graphics& g)
{
    ...
    Paint_Back3(g, juce::Colour(0xFF707070), juce::Colour(0xFF000000));
...
//R5.02 Fill the settings panel with a gradient shaded color. 
void MakoDist01AudioProcessorEditor::Paint_Back(juce::Graphics& g, juce::Colour col)
{
    //R5.02 Draw color Background, Dark Grey to color to Dark Grey. 
    ...
    g.fillRect(4, 89, 565, 52);
    ColGrad = juce::ColourGradient(juce::Colour(col), 0.0f, 140.0f, juce::Colour(0xFF101010), 0.0f, 247.0f, false);
    g.setGradientFill(ColGrad);
    g.fillRect(4, 140, 565, 85);
}

//R5.02 Fill the settings panel top section with a gradient shaded color. 
void MakoDist01AudioProcessorEditor::Paint_Back2(juce::Graphics& g, juce::Colour colTop, juce::Colour colBot)
{
    //R5.02 Draw color Background gradient top to bottom.
    g.setGradientFill(juce::ColourGradient(juce::Colour(colTop), 0, 63, juce::Colour(colBot), 570, 225, false));
    g.fillRect(4, 63, 565, 162);
}

//R5.02 Recessed gradient.
void MakoDist01AudioProcessorEditor::Paint_Back3(juce::Graphics& g, juce::Colour colTop, juce::Colour colBot)
{
    //R5.02 Draw recessed header.
    g.setGradientFill(juce::ColourGradient(juce::Colour(0,0,0), 0, 63, juce::Colour(colTop), 0, 88, false));
    g.fillRect(4, 63, 564, 25);

    //R5.02 Draw color Background gradient top to bottom.
    g.setGradientFill(juce::ColourGradient(juce::Colour(colTop), 0, 87, juce::Colour(colBot), 0, 225, false));
    g.fillRect(4, 87, 564, 138);   
}
...
void MakoDist01AudioProcessorEditor::resized()
{
    ...
    //R5.06 COMPRESSOR knobs.
    sldKnob[e_CompVol].setBounds(10, 110, 70, 70);
    sldKnob[e_CompAtt].setBounds(80, 110, 70, 70);
    sldKnob[e_CompRel].setBounds(150, 110, 70, 70);
    sldKnob[e_CompThr].setBounds(220, 110, 70, 70);
    sldKnob[e_CompRat].setBounds(290, 110, 70, 70);
    sldKnob[e_CompFreq].setBounds(360, 110, 70, 70); //R5.05 Added.
    sldKnob[e_CompMix].setBounds(430, 110, 70, 70);  //R5.06 Added.    
    sldKnob[e_CompDrv].setBounds(500, 110, 70, 70);
    ...
    //R5.06 FLANGER knobs.
    sldKnob[e_Mod1Vol].setBounds(30, 110, 70, 70);
    sldKnob[e_Mod1Rate].setBounds(100, 110, 70, 70);
    sldKnob[e_Mod1Depth].setBounds(170, 110, 70, 70);
    sldKnob[e_Mod1Reg].setBounds(240, 110, 70, 70);
    sldKnob[e_Mod1Mix].setBounds(310, 110, 70, 70);
    sldKnob[e_Mod1Synth].setBounds(400, 110, 70, 70);
    sldKnob[e_Mod1Bronz].setBounds(470, 110, 70, 70);
    ...
    //R4.00 CHORUS knobs.
    sldKnob[e_Mod3Vol].setBounds(40, 110, 70, 70);
    sldKnob[e_Mod3Mix].setBounds(120, 110, 70, 70);
    sldKnob[e_Mod3Rate].setBounds(210, 110, 70, 70);
    sldKnob[e_Mod3Depth].setBounds(290, 110, 70, 70);
    ...
    //R5.02 DELAY knobs.
    sldKnob[e_DelMix].setBounds(20, 115, 85, 85);
    sldKnob[e_DelRepeat].setBounds(118, 130, 70, 70);
    sldKnob[e_DelOffset].setBounds(208, 130, 70, 70);
    sldKnob[e_DelBal].setBounds(298, 130, 70, 70);
    sldKnob[e_DelDuck].setBounds(388, 130, 70, 70);
    sldKnob[e_DelTime].setBounds(470, 115, 85, 85);    

    labAmp_Comp.setBounds(363, 92, 4, 6);
    labPedal2_Comp.setBounds(220, 100, 4, 6);
...
{       
    ...
    if (butt == &butDefAmps)
    {
        ...
        if (makoProcessor.DefAmp_Page == 0)
        {
            int tI = cbAmpList.getSelectedId() - 1;
            if (tI < 0) tI = 0;
            makoProcessor.DefAmp_Page = tI / 10;
        }
        editMode = EM_DefAmps;
        makoProcessor.DefAmp_Editing = 1;    //R5.05 Flag we are editing the database.
        repaint();
    }
    if (butt == &butDefIRs)
    {
        //R4.00 If we are 1st editing, calculate the current page of edits.
        if (makoProcessor.DefIR_Page == 0)
        {
            int tI = cbIRList.getSelectedId() - 1;
            if (tI < 0) tI = 0;
            makoProcessor.DefIR_Page = tI / 10;
        }
        editMode = EM_DefIRs;
        makoProcessor.DefAmp_Editing = 1;    //R4.00 Flag we are editing the database.
        repaint();
    }
    ...
    if (butt == &butPageUp)
    {
        ...
        {
            if (0 < makoProcessor.DefAmp_Page) makoProcessor.DefAmp_Page--;
        }
        if (editMode == EM_DefIRs)
        {
            if (0 < makoProcessor.DefIR_Page) makoProcessor.DefIR_Page--;
        }
        repaint();
    }
    if (butt == &butPageDn)
    {
        if (editMode == EM_DefAmps)
        {
            if (makoProcessor.DefAmp_Page < 19) makoProcessor.DefAmp_Page++;
        }
        if (editMode == EM_DefIRs)
        {
            if (makoProcessor.DefIR_Page < 19) makoProcessor.DefIR_Page++;
        }
        repaint();
    }
        ...
        dlgFile->launchAsync(chooserFlags, [this](const juce::FileChooser& fc)
            {
                ...
                if (file != juce::File{})
                {
                    ...
                    DefAmp_Update = true;                    
                    makoProcessor.DefAmp_Editing = 2;  //R5.05 Flag that we have unsaved database entries.
...
{           
    ...
    if (FLAG_ClearHelp)
    {
        ...
        labHelp.setText("Mini Distortion - v5.06s", juce::sendNotification);
    }

    //R5.05 Force a redraw since we need our new IR selection to propagate from the processor.
    //R5.05 May need a processor var to sync the redraw. Keeping it simple for now.
    if (IR_NeedsRedraw)
    {
        IR_NeedsRedraw = false;
        repaint();
    }

    //R5.06 PROC has updated the VALUE TREE, update our GUI vars.
    if (makoProcessor.makoEditorNeedsUpdated)
    {
        makoProcessor.makoEditorNeedsUpdated = false;
        Mako_UpdateVals(false);
        repaint(); 
    }
...
void MakoDist01AudioProcessorEditor::Mouse_Check_DefAmp(int mButton, int posX, int posY)
{
    ...
    Idx = (9 - Idx) + (makoProcessor.DefAmp_Page * 10);
    ...
    if ((27 < posX) && (posX < 330))
    {
        makoProcessor.DefAmp_CurrentIdx = Idx; //R5.05 Changed.
        DefAmp_Update = true;
        makoProcessor.DefAmp_Editing = 2;   //R5.05 Flag that we have unsaved database entries.
    }
    ...
    {        
        ...
        //R5.05 Added Path viewing.
        if (mButton == 3)
        {
            labHelp.setText(makoProcessor.DefAmp_Path[Idx], juce::dontSendNotification);
        }
    }    
    repaint();
}
...
void MakoDist01AudioProcessorEditor::Mouse_Check_DefIR(int mButton, int posX, int posY)
{
    ...
    //R3.00 Offset row selection by PAGE value.
    Idx = (9 - Idx) + (makoProcessor.DefIR_Page * 10);
    ...
    if ((27 < posX) && (posX < 321))
    {
        makoProcessor.DefIR_CurrentIdx = Idx;
        DefIR_Update = true;
        makoProcessor.DefAmp_Editing = 2;  //R5.05 Flag that we have unsaved database entries.
        ...
        if (mButton == 3)
        {
            labHelp.setText(makoProcessor.DefIR_Path[Idx], juce::dontSendNotification);
        }
    }
    repaint();
}
...
{    
    //R4.00 Store the selected File and Path in the database.
    makoProcessor.DefAmp_Path[makoProcessor.DefAmp_CurrentIdx] = tFile;
    makoProcessor.DefAmp_File[makoProcessor.DefAmp_CurrentIdx] = makoProcessor.DefAmp_Path[makoProcessor.DefAmp_CurrentIdx].fromLastOccurrenceOf("\\", false, true);
...
{
    int tX;
    int P = makoProcessor.DefAmp_Page * 10;
    ...
    g.drawText("Middle Click to see path.", 415, 110, 200, 15, juce::Justification::topLeft, 0);
    g.drawText("(Number, EQ loc, Gain, Amp File)", 415, 125, 200, 15, juce::Justification::topLeft, 0);
    g.drawText("* Amps are fixed", 415, 140, 200, 15, juce::Justification::topLeft, 0);

    g.drawText("Files must be 1024 sample 48 kHz.", 415, 155, 200, 15, juce::Justification::topLeft, 0);
...
{
    int tX;
    int P = makoProcessor.DefIR_Page * 10;
    ...
    g.drawText("Right Click cell to delete.", 415, 95, 200, 15, juce::Justification::topLeft, 0);
    g.drawText("Middle Click to see path.", 415, 110, 200, 15, juce::Justification::topLeft, 0);
    g.drawText("(Number, IR File)", 415, 125, 200, 15, juce::Justification::topLeft, 0);
    g.drawText("* IRs are fixed", 415, 140, 200, 15, juce::Justification::topLeft, 0);
...
void MakoDist01AudioProcessorEditor::cbIRListChanged()
{
    ...
    if (19 < Idx)
    {
        //R5.01 Idx greater than 19 equals external IR.
        //R5.01 Check to see if we have a database entry at this index.
        ...
        //R5.01 Reset the IR settings.
        sldKnob[e_IRSize].setValue(.0f);
        sldKnob[e_IRVol].setValue(1.0f);

        //R5.05 Added to be more responsive.
        IR_NeedsRedraw = true;
    }
    else
    {
        ...
        //R5.01 Force default IR size and volume when coming from back from a file.
        if ((Idx < 20) && (19 < IR_LastSelected))
        {            
            sldKnob[e_IRSize].setValue(.0f);
            sldKnob[e_IRVol].setValue(1.0f);
        }       

        //R5.05 Since we have valid IR image, force a screen redraw.
        repaint();
    }

    //R5.01 Added to track changing of IRs. 
    IR_LastSelected = Idx;
...
void MakoDist01AudioProcessorEditor::FILE_Mako_IR_Load_Def(juce::String tFile)
{
    ...
    makoProcessor.DefIR_Path[makoProcessor.DefIR_CurrentIdx] = tFile;
    makoProcessor.DefIR_File[makoProcessor.DefIR_CurrentIdx] = makoProcessor.DefIR_Path[makoProcessor.DefIR_CurrentIdx].fromLastOccurrenceOf("\\", false, true);
...
void MakoDist01AudioProcessorEditor::FILE_Mako_Load(juce::String tFile)
{
    ...
    juce::FileInputStream Input(tFile);
    {
        ...
        if (Frev == 400)
        {
            //R5.02 Read every parameter/slider value. R4 files have 112 parameters.
            for (int t = 0; t < 112; t++)
            {
                //R5.04 Read the next parameter value.
                tPar = Input.readNextLine();

                //R5.04 Find the matching Parameter Index.
                //R5.04 Compare the R4 parm names to the new R5 names.
                for (int t2 = 0; t2 < e_PLast; t2++) //R5.06 e_PLast bug fix.
                {
                    if (e_strs[t2] == R4_strs[t])
                    {  
                        //R5.04 We have a match so store the parameter value in the R5 array index.
                        tSet[t2] = tPar.getFloatValue(); break;
                    }
                }
            ...
            //R5.05 NEED to set some old Rev 400 default values here.
            tSet[e_AmpAirF] = 1500.0f;
            tSet[e_CompFreq] = 4000.0f;  //R5.05 Added.
            tSet[e_CompMix] = 1.0f;      //R5.06 Added.
        ...
        if (Frev == 500)
        {   
            //R5.03 NEED to set some old Rev 500 default values here.
            tSet[e_AmpAirF] = 1500.0f;   //R5.03 Added.
            tSet[e_CompFreq] = 4000.0f;  //R5.05 Added.
            tSet[e_CompMix] = 1.0f;      //R5.06 Added.
        ...
        //R5.01 Apply the loaded settings to their LISTBOXES.
        ...
        cbRevMode.setSelectedId(int(tSet[e_RevMode]) + 1, juce::sendNotification);       //R5.01.
        ...
        {
            labError.setVisible(true);
            labError.setText("FILE ERROR: Missing values. Normal when loading older presets.", juce::sendNotification);
        }
