    ...
    : AudioProcessorEditor (&p), makoProcessor (p)
{
    ...
    labVersion.setText("v5.01s", juce::dontSendNotification);
...
{   
    ...
    Paint_Back3(g, juce::Colour(0xFFF0F0F0), juce::Colour(0xFF808080));
    Paint_VertDiv(g, 105, 100, 180);
    Paint_VertDiv(g, 325, 100, 180);

    //R5.01 Header rectangles.
...
{           
    ...
    if (FLAG_ClearHelp)
    {
        ...
        labHelp.setText("Mini Distortion - v5.01s", juce::sendNotification);
    }
