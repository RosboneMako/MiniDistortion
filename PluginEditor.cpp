    ...
    : AudioProcessorEditor (&p), makoProcessor (p)
{
    ...
    sldKnob[e_AmpThump].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000010));
    sldKnob[e_AmpAir].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000010));
    sldKnob[e_AmpPower].setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour(0x00000010));
    ...
    labVersion.setText("v5.02s", juce::dontSendNotification);
...
void MakoDist01AudioProcessorEditor::Paint_Amp(juce::Graphics& g)
{
    ...
    //R5.02 Draw color Background.
    Paint_Back3(g, juce::Colour(0xFF606060), juce::Colour(0xFF303030));
...
{           
    ...
    if (FLAG_ClearHelp)
    {
        ...
        labHelp.setText("Mini Distortion - v5.02s", juce::sendNotification);
    }
