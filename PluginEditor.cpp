    ...
    : AudioProcessorEditor (&p), makoProcessor (p)
{
    ...
    labVersion.setText("v5.04s", juce::dontSendNotification);
...
{           
    ...
    if (FLAG_ClearHelp)
    {
        ...
        labHelp.setText("Mini Distortion - v5.04s", juce::sendNotification);
    }
...
void MakoDist01AudioProcessorEditor::FILE_Mako_Load(juce::String tFile)
{
    ...
    juce::FileInputStream Input(tFile);
    {
        ...
        if (Frev == 400)
        {
            ...
            //R5.03 NEED to set some old Rev 400 default values here.
