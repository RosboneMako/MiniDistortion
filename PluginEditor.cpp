    ...
    : AudioProcessorEditor (&p), makoProcessor (p)
{
    ...
    labVersion.setText("v5.05s", juce::dontSendNotification);
    ...
    ParAtt[e_CompFreq] = std::make_unique <juce::AudioProcessorValueTreeState::SliderAttachment>(p.parameters, "comp_freq", sldKnob[e_CompFreq]);
...
void MakoDist01AudioProcessorEditor::Paint_Ped2(juce::Graphics& g)
{
    ...
    sldKnob[e_CompFreq].setVisible(true);
    ...
    g.drawText("Attack", 90, 95, 70, 15, juce::Justification::centred, 0);
    g.drawText("Release", 170, 95, 70, 15, juce::Justification::centred, 0);
    g.drawText("Threshold", 250, 95, 70, 15, juce::Justification::centred, 0);
    g.drawText("Ratio", 330, 95, 70, 15, juce::Justification::centred, 0);
    g.drawText("Trig Freq", 410, 95, 70, 15, juce::Justification::centred, 0);
    g.drawText("Drive", 490, 95, 70, 15, juce::Justification::centred, 0);
...
void MakoDist01AudioProcessorEditor::resized()
{
    ...
    sldKnob[e_CompAtt].setBounds(90, 110, 70, 70);
    sldKnob[e_CompRel].setBounds(170, 110, 70, 70);
    sldKnob[e_CompThr].setBounds(250, 110, 70, 70);
    sldKnob[e_CompRat].setBounds(330, 110, 70, 70);
    sldKnob[e_CompFreq].setBounds(410, 110, 70, 70); //R5.05 Added.
    sldKnob[e_CompDrv].setBounds(490, 110, 70, 70);    
    ...
    labPedal2_Comp.setBounds(250, 100, 4, 6);
...
{           
    ...
    if (FLAG_ClearHelp)
    {
        ...
        labHelp.setText("Mini Distortion - v5.05s", juce::sendNotification);
    }
